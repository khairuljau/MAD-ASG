  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: SizedBox(
        ...
        child: Card(
          color: color,
          margin: const EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0), // Adjust padding as desired
          child: Center(
            child: Column(
              ...
              children: [
                Image.asset(
                  imagePath,
                  height: height * 0.6, // Adjust image height based on tile height
                  width: width * 0.7, // Adjust image width based on tile width
                ),
                Text(title, 
                  textAlign: TextAlign.center,
                  style: const TextStyle(color: Color(0xFF0F4C82))),
              ],
            ),
          ),
        ),
